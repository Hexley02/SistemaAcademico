...
class Matricula:
    ...
    def get_id(self) -> int:  # Mudei de get_id_matricula para get_id (seu histórico usa get_id())
    ...
    def alterar_matricula(self, novo_status: bool = None) -> None:
    ...
    def adicionar_registro_disciplina(self, registro_pd: 'MatriculaPagaDisciplina') -> None:
