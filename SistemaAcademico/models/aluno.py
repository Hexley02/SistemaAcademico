...
class Aluno(Pessoa):
    ...
    def get_periodo_atual(self) -> int:
    ...
    def get_creditos_concluidos(self) -> int:
        return self.__creditos_concluidos
    
    # setter
    
    def set_periodo_atual(self, periodo: int) -> None:
    ...
    def atualizar_creditos(self, creditos: int) -> None:
