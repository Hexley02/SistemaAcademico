...
# getters
    ...
    #setter
    def set_nota_final(self, nota:float):
        if 0.0 <= nota <= 10.0:
...
# métodos 
    ...
    def verificar_aprovacao(self, media_minima: float = 7.0, media_limite_final: float = 4.0, media_aprovacao_final: float = 5.0, max_faltas: int = 20) -> str:
